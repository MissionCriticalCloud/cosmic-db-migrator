...
public class ScriptRunner {
    ...
    private static final Logger s_logger = LoggerFactory.getLogger(ScriptRunner.class);
    ...
    public ScriptRunner(final Connection connection, final boolean autoCommit, final boolean stopOnError, final boolean verbosity) {
        this.connection = connection;
        this.autoCommit = autoCommit;
        this.stopOnError = stopOnError;
