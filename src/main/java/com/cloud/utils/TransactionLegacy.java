...
public class TransactionLegacy implements Closeable {
    ...
    public static void initDataSource(final Properties dbProps) {
        ...
        try {
            ...
            if (s_dbHAEnabled) {
                ...
                logger.info("The slaves configured for Cloud Data base is/are : " + cloudSlaves);
            }
    ...
    private static void loadMariaDbDriver() {
        try {
            ...
            logger.debug("MariaDB driver loaded");
    ...
    public boolean lock(final String name, final int timeoutSeconds) {
        ...
        if (lockMaster == null) {
            throw new GeneralException("There's no support for locking yet");
        }
    ...
    public void start() {
        ...
        if (_conn != null) {
            try {
                ...
                throw new GeneralException("Unable to set auto commit: ", e);
            }
        }
    }
            ...
            switch (_dbId) {
                case CLOUD_DB:
                    if (s_ds != null) {
                        ...
                        throw new GeneralException("Database is not initialized, process is dying?");
                    }
                    break;
                case USAGE_DB:
                    if (s_usageDS != null) {
                    ...
                    break;
                default:
                    throw new GeneralException("No database selected for the transaction");
            }
    ...
    public boolean commit() {
        ...
        try {
            ...
            rollbackTransaction();
            throw new GeneralException("Unable to commit or close the connection. ", e);
        }
    }
