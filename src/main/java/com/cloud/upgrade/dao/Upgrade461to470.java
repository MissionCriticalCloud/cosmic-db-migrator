...
public class Upgrade461to470 implements DbUpgrade {
    ...
    public File[] getPrepareScripts() {
        ...
        if (script == null) {
            throw new GeneralException("Unable to find db/schema-461to470.sql");
        }
    ...
    public void alterAddColumnToCloudUsage(final Connection conn) {
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(alterTableSql)) {
            ...
            if (e.getMessage().contains("quota_calculated")) {
                ...
                throw new GeneralException("Unable to create column quota_calculated in table cloud_usage.cloud_usage", e);
            }
        }
    }
    ...
    public File[] getCleanupScripts() {
        ...
        if (script == null) {
            throw new GeneralException("Unable to find db/schema-461to470-cleanup.sql");
        }
