...
public class Upgrade511to520 implements DbUpgrade {

    final static Logger logger = LoggerFactory.getLogger(Upgrade511to520.class);
    private static final String PREVIOUS_VERSION = "5.1.1";
    private static final String NEXT_VERSION = "5.2.0";
    private static final String SCHEMA_SCRIPT = "db/schema-511to520.sql";
    private static final String SCHEMA_CLEANUP_SCRIPT = "db/schema-511to520-cleanup.sql";
    ...
    public void performDataMigration(final Connection conn) {
        logger.info("Performing data migration from 5.1.1 to 5.2.0");
